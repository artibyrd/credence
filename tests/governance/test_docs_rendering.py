...
DOCS_DIR = Path(__file__).resolve().parents[2].parent / "credence-docs"
...
async def test_cross_domain_consistent_navigation_and_footers(page: Page, docs_server: str) -> None:
    ...
    assert (
        "14 Zero-Build Interactive Playgrounds" in content_text
        or "12 Zero-Build Interactive Playgrounds" in content_text
        or "12 Zero-Build Playgrounds" in content_text
    )
