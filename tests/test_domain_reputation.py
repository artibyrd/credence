...
def test_calculate_polling_backoff() -> None:
    ...
    assert calculate_polling_backoff(0) == 1.0
    assert calculate_polling_backoff(1) == 2.0
    assert calculate_polling_backoff(2) == 4.0
    assert calculate_polling_backoff(3) == 8.0
    assert calculate_polling_backoff(4) == 16.0
    assert calculate_polling_backoff(5) == 32.0
    assert calculate_polling_backoff(6) == 64.0
    assert calculate_polling_backoff(10) == 64.0  # Capped at 64x
