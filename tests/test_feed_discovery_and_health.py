...
def test_topic_entropy_diverse_vs_commercial_astroturfing():
    ...
    h_diverse = calculate_topic_entropy(diverse_articles)
    ...
    h_astroturfed = calculate_topic_entropy(astroturfed_articles)
...
def test_feed_quality_score_composite_math():
    ...
    metrics_clean = calculate_feed_quality_score([clean_report], published_dates=[now], now=now)
    ...
    metrics_deceptive = calculate_feed_quality_score([deceptive_report], published_dates=[now], now=now)
