...
def test_empirical_expertise_mathematical_formula():
    ...
    assert compute_subject_expertise(empty_metrics) == 0.05
    ...
    assert compute_subject_expertise(expert_metrics) == 1.0
    ...
    partial_score = compute_subject_expertise(partial_metrics)
    ...
    assert compute_subject_expertise(expert_slashed_1) == pytest.approx(0.50, rel=0.05)
...
def test_effective_authority_weight_beekeeper_vs_dogwalker():
    ...
    beekeeper_weight = compute_effective_weight(
    ...
    dogwalker_weight = compute_effective_weight(
    ...
    dogwalker_canine_weight = compute_effective_weight(
        node_pubkey="dogwalker_node",
